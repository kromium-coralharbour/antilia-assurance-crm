      ...
      {selected && (
        <div className="modal-backdrop" onClick={() => setSelected(null)}>
          <div onClick={e => e.stopPropagation()} style={{ background: '#111827', border: '1px solid rgba(201,147,58,0.2)', width: '100%', maxWidth: 680, maxHeight: '92vh', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
            ...
            {treatyTab === 'financials' && (
              <div style={{ padding: '1.5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.2rem' }}>
                  <div style={{ fontFamily: 'Barlow Condensed', fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: '#8fa3b8' }}>YTD Financial Position</div>
                  ...
                  return (
                    <div style={{ padding: '1rem', background: 'rgba(46,64,96,0.2)', border: '1px solid rgba(201,147,58,0.1)' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.4rem' }}>
                        <span style={{ fontFamily: 'Barlow Condensed', fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#8fa3b8' }}>Treaty Utilisation</span>
                      ...
                      <div style={{ fontFamily: 'Barlow Condensed', fontSize: '0.65rem', color: '#4a6080', marginTop: '0.3rem' }}>
            ...
            {treatyTab === 'claims' && (
              <div style={{ flex: 1 }}>
                {treatyLoading ? <div style={{ padding: '2rem', textAlign: 'center', color: '#8fa3b8' }}>Loading…</div> :
                treatyClaims.length === 0 ? <div style={{ padding: '2rem', textAlign: 'center', color: '#4a6080', fontFamily: 'Barlow Condensed', letterSpacing: '0.1em' }}>No active claims in covered islands</div> :
                treatyClaims.map(c => (
